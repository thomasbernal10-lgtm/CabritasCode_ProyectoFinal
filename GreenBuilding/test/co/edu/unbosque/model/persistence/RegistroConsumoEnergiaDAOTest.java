...
public class RegistroConsumoEnergiaDAOTest {

	static RegistroConsumoEnergiaDAO dao;
	static String ARCHIVO_ORIGINAL = "registrosconsumoenergy.dat";
	...
	public static void antesDeTodo() {
		...
		dao = new RegistroConsumoEnergiaDAO();
		System.out.println("Iniciando pruebas de RegistroConsumoEnergiaDAO");
	}
	...
	public void actualizarPosicionInvalida() {
		boolean resultado = dao.actualizar(99, new RegistroConsumoEnergiaDTO());
	...
	public static void despuesDeTodo() {
		...
		System.err.println("Finalizando todas las pruebas de RegistroConsumoEnergiaDAO");
	}
}