...
public class RegistroConsumoAguaDAOTest {

	static RegistroConsumoAguaDAO dao;
	static String ARCHIVO_ORIGINAL = "registrosconsumoagua.dat";
	...
	public static void antesDeTodo() {
		...
		dao = new RegistroConsumoAguaDAO();
		System.out.println("Iniciando pruebas de RegistroConsumoAguaDAO");
	}
	...
	public void actualizarPosicionInvalida() {
		boolean resultado = dao.actualizar(99, new RegistroConsumoAguaDTO());
	...
	public static void despuesDeTodo() {
		...
		System.err.println("Finalizando todas las pruebas de RegistroConsumoAguaDAO");
	}
}