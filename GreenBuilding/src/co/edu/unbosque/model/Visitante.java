...
/**
 * Representa un visitante registrado dentro del sistema GreenBuilding Manager.
 * Esta clase almacena la informacion relacionada con las personas externas
 * autorizadas para ingresar al conjunto residencial.
 * 
 ...
 * <b>post</b> El visitante queda registrado y disponible para procesos de
 * control de acceso y seguimiento dentro del sistema. <br>
 * 
...
public class Visitante extends Persona {
	...
	/**
	 * Constructor por defecto. Crea un objeto Visitante sin datos inicializados.
	 * <b>pre</b> No existen precondiciones para este constructor. <br>
	 * <b>post</b> Se crea un objeto Visitante con todos sus atributos en null o
	...
	/**
	 * Constructor completo. Crea un objeto Visitante con toda la informacion
	 * necesaria.
	 * 
	 * <b>pre</b> El id, nombre, cedula y tipo no deben ser null. <br>
	 * <b>post</b> Se crea un objeto Visitante inicializado con la informacion
	 * suministrada. <br>
	 * 
	 ...
	 */
	public Visitante(String id, String nombre, String cedula, String telefono, String tipo,
