...
/**
 * Objeto de transferencia de datos (DTO) que representa un incidente de
 * convivencia registrado dentro del conjunto residencial. Se utiliza para
 * transportar la informacion del incidente entre las capas del sistema sin
 * exponer directamente la entidad del modelo. <b>pre</b> El DTO debe ser
 * construido con datos validos provenientes de la capa de persistencia o de la
 * interfaz grafica. <br>
 * <b>post</b> El objeto IncidenteDTO queda disponible para ser transferido
...
public class IncidenteDTO implements Serializable {
	...
	/**
	 * Constructor por defecto. Crea un IncidenteDTO sin datos inicializados.
	 * <b>pre</b> No hay precondiciones para este constructor. <br>
	 * <b>post</b> Se crea un objeto IncidenteDTO con todos sus atributos en null o
	...
	/**
	 * Constructor completo. Crea un IncidenteDTO con sus atributos principales
	 ...
	 * <b>post</b> Se crea un objeto IncidenteDTO listo para ser transferido entre
	 * las capas del sistema. El atributo resolucion queda en null hasta que el
	 ...
	 *                               caso contrario
	 */
	public IncidenteDTO(String id, String tipo, String gravedad, String descripcion, Apartamento apartamentoInvolucrado,
	 ...
	 * <b>pre</b> El objeto IncidenteDTO debe estar instanciado. <br>
	...
	/**
	 * Retorna el identificador unico del incidente. <b>pre</b> El objeto
	 * IncidenteDTO debe estar instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 *
	...
	/**
	 * Asigna el identificador unico del incidente. <b>pre</b> El objeto
	 * IncidenteDTO debe estar instanciado. <br>
	...
	/**
	 * Retorna el tipo del incidente. <b>pre</b> El objeto IncidenteDTO debe estar
	 * instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 *
	...
	/**
	 * Asigna el tipo del incidente. <b>pre</b> El objeto IncidenteDTO debe estar
	 * instanciado. <br>
	...
	/**
	 * Retorna el nivel de gravedad del incidente. <b>pre</b> El objeto IncidenteDTO
	...
	/**
	 * Asigna el nivel de gravedad del incidente. <b>pre</b> El objeto IncidenteDTO
	 * debe estar instanciado. <br>
	...
	/**
	 * Asigna la descripcion detallada del incidente. <b>pre</b> El objeto
	 * IncidenteDTO debe estar instanciado. <br>
	 ...
	 * El objeto IncidenteDTO debe estar instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 *
	 ...
	 * objeto IncidenteDTO debe estar instanciado. <br>
	...
	/**
	 * Retorna el estado actual del incidente. <b>pre</b> El objeto IncidenteDTO
	 * debe estar instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 *
	...
	/**
	 * Asigna el estado actual del incidente. <b>pre</b> El objeto IncidenteDTO debe
	...
	/**
	 * Retorna una representacion en texto del IncidenteDTO con sus datos
	 * principales. <b>pre</b> El objeto IncidenteDTO debe estar instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 *
