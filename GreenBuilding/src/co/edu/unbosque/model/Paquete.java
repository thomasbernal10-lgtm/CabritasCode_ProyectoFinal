...
/**
 * Representa un paquete o correspondencia recibido en la porteria del conjunto
 * residencial. Cada paquete almacena informacion relacionada con el remitente,
 * el apartamento destino, las fechas de recepcion y entrega, el estado actual y
 * las personas involucradas en el proceso de recepcion y entrega.
 * 
 * El registro de paquetes permite mejorar la trazabilidad, seguridad y control
 * de correspondencia dentro del sistema GreenBuilding Manager. <b>pre</b> El
 * apartamento destino debe estar registrado previamente en el sistema. <br>
 * <b>post</b> El paquete queda disponible para consultas, notificaciones y
 * seguimiento dentro del sistema. <br>
 * 
...
public class Paquete implements Serializable {
	...
	/**
	 * Constructor por defecto. Crea un paquete sin datos inicializados. <b>pre</b>
	 * No hay precondiciones para este constructor. <br>
	 * <b>post</b> Se crea un objeto Paquete con todos sus atributos en null o
	...
	/**
	 * Constructor completo. Crea un paquete con sus atributos principales
	 ...
	 * en el sistema. <br>
	 * <b>post</b> Se crea un objeto Paquete completamente inicializado y listo para
	 ...
	 *                           != ""
	 */
	public Paquete(String id, String descripcion, String remitente, Apartamento apartamentoDestino,
	 ...
	 * Paquete debe estar instanciado. <br>
	 ...
	 * objeto Paquete debe estar instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
	...
	/**
	 * Retorna el identificador unico del paquete. <b>pre</b> El objeto Paquete debe
	...
	/**
	 * Asigna el identificador unico del paquete. <b>pre</b> El objeto Paquete debe
	 * estar instanciado. <br>
	...
	/**
	 * Retorna la descripcion general del paquete. <b>pre</b> El objeto Paquete debe
	 * estar instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
	...
	/**
	 * Asigna la descripcion general del paquete. <b>pre</b> El objeto Paquete debe
	 * estar instanciado. <br>
	...
	/**
	 * Retorna el nombre del remitente del paquete. <b>pre</b> El objeto Paquete
	...
	/**
	 * Asigna el remitente del paquete. <b>pre</b> El objeto Paquete debe estar
	 * instanciado. <br>
	...
	/**
	 * Asigna la fecha y hora de recepcion del paquete. <b>pre</b> El objeto Paquete
	 * debe estar instanciado. <br>
	...
	/**
	 * Asigna el vigilante que recibio el paquete. <b>pre</b> El objeto Paquete debe
	 * estar instanciado. <br>
	...
	/**
	 * Retorna el estado actual del paquete. <b>pre</b> El objeto Paquete debe estar
	 * instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
	...
	/**
	 * Asigna el estado actual del paquete. <b>pre</b> El objeto Paquete debe estar
	 * instanciado. <br>
	...
	/**
	 * Retorna la fecha y hora de entrega del paquete. <b>pre</b> El objeto Paquete
	 * debe estar instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
	...
	/**
	 * Asigna la fecha y hora de entrega del paquete. <b>pre</b> El objeto Paquete
	 * debe estar instanciado. <br>
	...
	/**
	 * Asigna la persona que recibio el paquete. <b>pre</b> El objeto Paquete debe
	 * estar instanciado. <br>
	 ...
	 * <b>pre</b> El objeto Paquete debe estar instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
