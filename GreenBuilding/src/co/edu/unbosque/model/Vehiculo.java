...
/**
 * Representa un vehiculo registrado dentro del sistema GreenBuilding Manager.
 * Esta clase permite almacenar y gestionar la informacion relacionada con los
 * vehiculos asociados a los apartamentos del conjunto residencial.
 * 
 ...
 * <b>post</b> El vehiculo queda registrado y disponible para procesos de
 * control de acceso y administracion de parqueaderos. <br>
 * 
...
public class Vehiculo implements Serializable {
	...
	/**
	 * Constructor por defecto. Crea un objeto Vehiculo sin datos inicializados.
	 * <b>pre</b> No existen precondiciones para este constructor. <br>
	 * <b>post</b> Se crea un objeto Vehiculo con todos sus atributos en null o
	...
	/**
	 * Constructor completo. Crea un objeto Vehiculo con toda la informacion
	 * necesaria. <b>pre</b> El id, placa, tipo, marca, modelo y color no deben ser
	 * null. <br>
	 * <b>post</b> Se crea un objeto Vehiculo inicializado con la informacion
	 * suministrada. <br>
	 * 
	 ...
	 */
	public Vehiculo(String id, String placa, String tipo, String marca, String modelo, String color,
