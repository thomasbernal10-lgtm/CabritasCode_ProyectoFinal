...
/**
 * Representa una unidad habitacional (apartamento) dentro de una torre del
 * conjunto residencial. Cada apartamento tiene un estado que indica si esta
 * ocupado por su propietario, arrendado o desocupado, y puede tener asociado un
 * propietario y/o un arrendatario. <b>pre</b> La torre a la que pertenece el
 * apartamento debe estar registrada en el sistema. <br>
 * <b>post</b> El apartamento queda disponible para ser asociado a residentes,
 * reservas, pagos e incidentes dentro del sistema. <br>
 * 
...
public class Apartamento implements Serializable {
	...
	/**
	 * Constructor por defecto. Crea un apartamento sin datos inicializados.
	 * <b>pre</b> No hay precondiciones para este constructor. <br>
	 * <b>post</b> Se crea un objeto Apartamento con todos sus atributos en null o
	...
	/**
	 * Constructor completo. Crea un apartamento con todos sus atributos
	 ...
	 * <br>
	 * <b>post</b> Se crea un objeto Apartamento completamente inicializado y listo
	 ...
	 *                     arrendado
	 */
	public Apartamento(String id, String numero, int piso, Torre torre, String estado, Propietario propietario,
	 ...
	 * propietario. <b>pre</b> El objeto Apartamento debe estar instanciado. <br>
	 ...
	 * <b>pre</b> El objeto Apartamento debe estar instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
	 ...
	 * Apartamento debe estar instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
	...
	/**
	 * Retorna el numero o codigo del apartamento. <b>pre</b> El objeto Apartamento
	...
	/**
	 * Asigna el numero o codigo del apartamento. <b>pre</b> El objeto Apartamento
	 * debe estar instanciado. <br>
	...
	/**
	 * Retorna el numero de piso del apartamento. <b>pre</b> El objeto Apartamento
	 * debe estar instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
	...
	/**
	 * Asigna el numero de piso del apartamento. <b>pre</b> El objeto Apartamento
	 * debe estar instanciado. <br>
	 ...
	 * El objeto Apartamento debe estar instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
	 ...
	 * objeto Apartamento debe estar instanciado. <br>
	...
	/**
	 * Retorna el estado actual del apartamento. <b>pre</b> El objeto Apartamento
	 * debe estar instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
	...
	/**
	 * Asigna el estado actual del apartamento. <b>pre</b> El objeto Apartamento
	 * debe estar instanciado. <br>
	...
	/**
	 * Asigna el propietario del apartamento. <b>pre</b> El objeto Apartamento debe
	...
	/**
	 * Asigna el arrendatario del apartamento. <b>pre</b> El objeto Apartamento debe
	 * estar instanciado. <br>
	...
	/**
	 * Retorna una representacion en texto del apartamento con sus datos
	 * principales. <b>pre</b> El objeto Apartamento debe estar instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
