...
/**
 * Representa un pago realizado por un apartamento dentro del conjunto
 * residencial. Cada pago almacena informacion relacionada con el monto pagado,
 * la fecha en la que se realizo, el medio de pago utilizado y la persona que
 * registro la transaccion dentro del sistema. Los pagos permiten llevar control
 * sobre las obligaciones financieras de los residentes y apoyar la gestion
 * administrativa de la copropiedad. <b>pre</b> El apartamento asociado al pago
 * debe estar registrado previamente en el sistema. <br>
 * <b>post</b> El pago queda disponible para consultas, reportes financieros y
 * seguimiento de obligaciones dentro del sistema. <br>
 * 
...
public class Pago implements Serializable {
	...
	/**
	 * Constructor por defecto. Crea un pago sin datos inicializados. <b>pre</b> No
	 * hay precondiciones para este constructor. <br>
	 * <b>post</b> Se crea un objeto Pago con todos sus atributos en null o valores
	 * por defecto. <br>
	 */
	public Pago() {
	}
	...
	/**
	 * Constructor completo. Crea un pago con todos sus atributos inicializados.
	 * <b>pre</b> Los parametros id y medioPago no deben ser null ni vacios. El
	 * apartamento debe estar previamente registrado en el sistema. <br>
	 * <b>post</b> Se crea un objeto Pago completamente inicializado y listo para
	 * ser registrado dentro del sistema. <br>
	 * 
	 ...
	 */
	public Pago(String id, Apartamento apartamento, double monto, LocalDate fechaPago, String medioPago,
	 ...
	 * El objeto Pago debe estar instanciado. <br>
	 ...
	 * <b>pre</b> El objeto Pago debe estar instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
	...
	/**
	 * Retorna el identificador unico del pago. <b>pre</b> El objeto Pago debe estar
	 * instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
	...
	/**
	 * Asigna el identificador unico del pago. <b>pre</b> El objeto Pago debe estar
	 * instanciado. <br>
	...
	/**
	 * Retorna el apartamento asociado al pago. <b>pre</b> El objeto Pago debe estar
	 * instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
	...
	/**
	 * Asigna el apartamento asociado al pago. <b>pre</b> El objeto Pago debe estar
	 * instanciado. <br>
	...
	/**
	 * Retorna el valor monetario del pago. <b>pre</b> El objeto Pago debe estar
	 * instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
	...
	/**
	 * Asigna el valor monetario del pago. <b>pre</b> El objeto Pago debe estar
	 * instanciado. <br>
	...
	/**
	 * Retorna la fecha en la que se realizo el pago. <b>pre</b> El objeto Pago debe
	...
	/**
	 * Asigna la fecha en la que se realizo el pago. <b>pre</b> El objeto Pago debe
	 * estar instanciado. <br>
	...
	/**
	 * Retorna el medio utilizado para realizar el pago. <b>pre</b> El objeto Pago
	...
	/**
	 * Asigna el medio utilizado para realizar el pago. <b>pre</b> El objeto Pago
	 * debe estar instanciado. <br>
	...
	/**
	 * Retorna la referencia asociada al pago. <b>pre</b> El objeto Pago debe estar
	 * instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
	...
	/**
	 * Asigna la referencia asociada al pago. <b>pre</b> El objeto Pago debe estar
	 * instanciado. <br>
	...
	/**
	 * Retorna el usuario que registro el pago. <b>pre</b> El objeto Pago debe estar
	 * instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
	...
	/**
	 * Asigna el usuario que registro el pago. <b>pre</b> El objeto Pago debe estar
	 * instanciado. <br>
