 ...
 * hereda de Persona y permite gestionar la informacion relacionada con los
...
public class ResidenteDTO extends Persona {
	...
	/**
	 * Constructor por defecto. Crea un objeto ResidenteDTO sin datos inicializados.
	 * <b>pre</b> No existen precondiciones para este constructor. <br>
	 * <b>post</b> Se crea un objeto ResidenteDTO con todos sus atributos en null,
	...
	/**
	 * Constructor completo. Crea un objeto ResidenteDTO con todos sus atributos
	 ...
	 * <br>
	 * <b>post</b> Se crea un objeto ResidenteDTO completamente inicializado y listo
	 ...
	 */
	public ResidenteDTO(String id, String nombre, String cedula, String telefono, String correo,
			String contactoEmergencia, String telefonoEmergencia, Apartamento apartamento, String tipo,
			boolean activo) {
	...
	/**
	 * Retorna el tipo propietario. <b>pre</b> El objeto ResidenteDTO debe estar
	 * instanciado. <br>
	...
	/**
	 * Retorna el tipo arrendatario. <b>pre</b> El objeto ResidenteDTO debe estar
	 * instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
	...
	/**
	 * Retorna el tipo familiar. <b>pre</b> El objeto ResidenteDTO debe estar
	 * instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
	...
	/**
	 * Retorna el tipo empleado domestico. <b>pre</b> El objeto ResidenteDTO debe
	...
	/**
	 * Retorna el apartamento asociado al residente. <b>pre</b> El objeto
	 * ResidenteDTO debe estar instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
	...
	/**
	 * Asigna el apartamento asociado al residente. <b>pre</b> El objeto
	 * ResidenteDTO debe estar instanciado. <br>
	...
	/**
	 * Retorna el tipo de residente. <b>pre</b> El objeto ResidenteDTO debe estar
	 * instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
	...
	/**
	 * Asigna el tipo de residente. <b>pre</b> El objeto ResidenteDTO debe estar
	 * instanciado. <br>
	...
	/**
	 * Retorna el estado de actividad del residente. <b>pre</b> El objeto
	 * ResidenteDTO debe estar instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
	...
	/**
	 * Asigna el estado de actividad del residente. <b>pre</b> El objeto
	 * ResidenteDTO debe estar instanciado. <br>
	 ...
	 * <b>pre</b> El objeto ResidenteDTO debe estar instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
