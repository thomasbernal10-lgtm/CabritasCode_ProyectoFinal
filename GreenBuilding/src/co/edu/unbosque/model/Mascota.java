...
/**
 * Representa una mascota registrada dentro del conjunto residencial y asociada
 * a un apartamento especifico. Almacena informacion de identificacion,
 * caracteristicas fisicas y estado de vacunacion del animal. <b>pre</b> El
 * apartamento al que se asocia la mascota debe estar registrado en el sistema
 * antes de crear el objeto. <br>
 * <b>post</b> La mascota queda disponible para ser consultada, relacionada con
 * su apartamento y verificada en cuanto a su estado de vacunacion. <br>
 *
...
public class Mascota implements Serializable {
	...
	/**
	 * Constructor por defecto. Crea una mascota sin datos inicializados. <b>pre</b>
	 * No hay precondiciones para este constructor. <br>
	 * <b>post</b> Se crea un objeto Mascota con todos sus atributos en null o
	...
	/**
	 * Constructor completo. Crea una mascota con todos sus atributos inicializados.
	 * <b>pre</b> Los parametros id, nombre y especie no deben ser null ni vacios.
	 * El apartamento debe estar registrado en el sistema. <br>
	 * <b>post</b> Se crea un objeto Mascota completamente inicializado y listo para
	 ...
	 *                        contrario
	 */
	public Mascota(String id, String nombre, String especie, String raza, String color, Apartamento apartamento,
	...
	/**
	 * Retorna el identificador unico de la mascota. <b>pre</b> El objeto Mascota
	...
	/**
	 * Asigna el identificador unico de la mascota. <b>pre</b> El objeto Mascota
	 * debe estar instanciado. <br>
	...
	/**
	 * Retorna el nombre de la mascota. <b>pre</b> El objeto Mascota debe estar
	 * instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 *
	...
	/**
	 * Asigna el nombre de la mascota. <b>pre</b> El objeto Mascota debe estar
	 * instanciado. <br>
	...
	/**
	 * Retorna la especie de la mascota. <b>pre</b> El objeto Mascota debe estar
	 * instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 *
	...
	/**
	 * Asigna la especie de la mascota. <b>pre</b> El objeto Mascota debe estar
	 * instanciado. <br>
	...
	/**
	 * Retorna la raza de la mascota. <b>pre</b> El objeto Mascota debe estar
	 * instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 *
	...
	/**
	 * Asigna la raza de la mascota. <b>pre</b> El objeto Mascota debe estar
	 * instanciado. <br>
	 ...
	 * Mascota debe estar instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 *
	 ...
	 * El objeto Mascota debe estar instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 *
	...
	/**
	 * Indica si la mascota tiene sus vacunas al dia. <b>pre</b> El objeto Mascota
	 * debe estar instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 *
	...
	/**
	 * Asigna si la mascota tiene sus vacunas al dia. <b>pre</b> El objeto Mascota
	 * debe estar instanciado. <br>
	...
	/**
	 * Retorna una representacion en texto de la mascota con sus datos principales.
	 * <b>pre</b> El objeto Mascota debe estar instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 *
