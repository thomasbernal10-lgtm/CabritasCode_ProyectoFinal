...
/**
 * Representa un parqueadero dentro del conjunto residencial administrado por el
 * sistema GreenBuilding Manager. Cada parqueadero almacena informacion
 * relacionada con su numero identificador, tipo, estado actual, conjunto al que
 * pertenece y el vehiculo asignado.
 * 
 * Los parqueaderos permiten organizar y controlar los espacios destinados para
 * vehiculos de residentes, visitantes y medios de transporte especiales dentro
 * de la copropiedad. <b>pre</b> El conjunto asociado debe estar registrado
 * previamente en el sistema. <br>
 * <b>post</b> El parqueadero queda disponible para consultas, asignaciones y
 * procesos administrativos dentro del sistema. <br>
 * 
...
public class Parqueadero implements Serializable {
	...
	/**
	 * Constructor por defecto. Crea un parqueadero sin datos inicializados.
	 * <b>pre</b> No existen precondiciones para este constructor. <br>
	 * <b>post</b> Se crea un objeto Parqueadero con todos sus atributos en null o
	...
	/**
	 * Constructor completo. Crea un parqueadero con sus atributos principales
	 * inicializados. <b>pre</b> Los parametros id, numero, tipo y estado no deben
	 * ser null ni vacios. El conjunto debe existir previamente en el sistema. <br>
	 * <b>post</b> Se crea un objeto Parqueadero completamente inicializado y listo
	 * para ser registrado dentro del sistema. <br>
	 * 
	 ...
	 */
	public Parqueadero(String id, String numero, String tipo, String estado, Conjunto conjunto) {
		this.id = id;
		this.numero = numero;
		this.tipo = tipo;
		this.estado = estado;
	 ...
	 * El objeto Parqueadero debe estar instanciado. <br>
	 ...
	 * <b>pre</b> El objeto Parqueadero debe estar instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
	 ...
	 * objeto Parqueadero debe estar instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
	 ...
	 * Parqueadero debe estar instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
	...
	/**
	 * Retorna el tipo del parqueadero. <b>pre</b> El objeto Parqueadero debe estar
	 * instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
	...
	/**
	 * Asigna el tipo del parqueadero. <b>pre</b> El objeto Parqueadero debe estar
	 * instanciado. <br>
	...
	/**
	 * Retorna el estado actual del parqueadero. <b>pre</b> El objeto Parqueadero
	...
	/**
	 * Asigna el estado actual del parqueadero. <b>pre</b> El objeto Parqueadero
	 * debe estar instanciado. <br>
	...
	/**
	 * Retorna el conjunto asociado al parqueadero. <b>pre</b> El objeto Parqueadero
	 * debe estar instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
	...
	/**
	 * Asigna el conjunto asociado al parqueadero. <b>pre</b> El objeto Parqueadero
	 * debe estar instanciado. <br>
	...
	/**
	 * Retorna el vehiculo asignado al parqueadero. <b>pre</b> El objeto Parqueadero
	 * debe estar instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
	...
	/**
	 * Asigna el vehiculo asociado al parqueadero. <b>pre</b> El objeto Parqueadero
	 * debe estar instanciado. <br>
	 ...
	 * principales. <b>pre</b> El objeto Parqueadero debe estar instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
