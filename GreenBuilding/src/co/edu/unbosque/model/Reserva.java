...
/**
 * Representa una reserva de una zona comun dentro del sistema GreenBuilding
 * Manager. Esta clase almacena la informacion relacionada con las solicitudes
 * realizadas por los residentes para el uso de espacios comunes del conjunto
 * residencial.
 * 
 * Una reserva permite gestionar fechas, horarios, estados y motivos de
 * cancelacion asociados al uso de las zonas comunes. <b>pre</b> El apartamento
 * y la zona comun deben existir previamente en el sistema. La fecha y las horas
 * deben corresponder a valores validos. <br>
 * <b>post</b> La reserva queda disponible para procesos de consulta,
 * administracion y seguimiento dentro del sistema. <br>
 * 
...
public class Reserva implements Serializable {
	...
	/**
	 * Constructor por defecto. Crea un objeto Reserva sin datos inicializados.
	 * <b>pre</b> No existen precondiciones para este constructor. <br>
	 * <b>post</b> Se crea un objeto Reserva con todos sus atributos en null o
	...
	/**
	 * Constructor completo. Crea un objeto Reserva con todos sus atributos
	 * inicializados. <b>pre</b> El id, apartamento, zona, fecha, horaInicio,
	 * horaFin, estado y fechaSolicitud no deben ser null. <br>
	 * <b>post</b> Se crea un objeto Reserva completamente inicializado y listo para
	 ...
	 */
	public Reserva(String id, Apartamento apartamento, ZonaComun zona, LocalDate fecha, LocalTime horaInicio,
	...
	/**
	 * Retorna el estado pendiente de la reserva. <b>pre</b> El objeto Reserva debe
	...
	/**
	 * Retorna el estado confirmada de la reserva. <b>pre</b> El objeto Reserva debe
	 * estar instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
	...
	/**
	 * Retorna el estado cancelada de la reserva. <b>pre</b> El objeto Reserva debe
	 * estar instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
	...
	/**
	 * Retorna el estado incumplida de la reserva. <b>pre</b> El objeto Reserva debe
	 * estar instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
	...
	/**
	 * Retorna el estado completada de la reserva. <b>pre</b> El objeto Reserva debe
	 * estar instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
	...
	/**
	 * Retorna el identificador unico de la reserva. <b>pre</b> El objeto Reserva
	...
	/**
	 * Asigna el identificador unico de la reserva. <b>pre</b> El objeto Reserva
	 * debe estar instanciado. <br>
	...
	/**
	 * Retorna el apartamento asociado a la reserva. <b>pre</b> El objeto Reserva
	 * debe estar instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
	...
	/**
	 * Asigna el apartamento asociado a la reserva. <b>pre</b> El objeto Reserva
	 * debe estar instanciado. <br>
	...
	/**
	 * Retorna la zona comun asociada a la reserva. <b>pre</b> El objeto Reserva
	 * debe estar instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
	...
	/**
	 * Asigna la zona comun asociada a la reserva. <b>pre</b> El objeto Reserva debe
	 * estar instanciado. <br>
	...
	/**
	 * Retorna la fecha de la reserva. <b>pre</b> El objeto Reserva debe estar
	 * instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
	...
	/**
	 * Asigna la fecha de la reserva. <b>pre</b> El objeto Reserva debe estar
	 * instanciado. <br>
	...
	/**
	 * Retorna la hora de inicio de la reserva. <b>pre</b> El objeto Reserva debe
	 * estar instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
	...
	/**
	 * Asigna la hora de inicio de la reserva. <b>pre</b> El objeto Reserva debe
	 * estar instanciado. <br>
	...
	/**
	 * Retorna la hora de finalizacion de la reserva. <b>pre</b> El objeto Reserva
	 * debe estar instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
	...
	/**
	 * Asigna la hora de finalizacion de la reserva. <b>pre</b> El objeto Reserva
	 * debe estar instanciado. <br>
	...
	/**
	 * Retorna el estado de la reserva. <b>pre</b> El objeto Reserva debe estar
	 * instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
	...
	/**
	 * Asigna el estado de la reserva. <b>pre</b> El objeto Reserva debe estar
	 * instanciado. <br>
	 ...
	 * Reserva debe estar instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
	...
	/**
	 * Retorna el motivo de cancelacion de la reserva. <b>pre</b> El objeto Reserva
	 * debe estar instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
	...
	/**
	 * Asigna el motivo de cancelacion de la reserva. <b>pre</b> El objeto Reserva
	 * debe estar instanciado. <br>
	 ...
	 * <b>pre</b> El objeto Reserva debe estar instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
