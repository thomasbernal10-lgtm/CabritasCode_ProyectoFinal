...
/**
 * Representa un objeto de transferencia de datos (DTO) para registros de
 * reciclaje dentro del sistema GreenBuilding Manager. Esta clase hereda de
 * RegistroConsumo y permite transportar informacion relacionada con las
 * cantidades recicladas por categoria entre las diferentes capas de la
 * aplicacion sin exponer directamente la logica de negocio.
 * 
 * Cada objeto RegistroReciclajeDTO almacena cantidades recicladas de papel,
 * plastico, vidrio, metal y residuos organicos, asi como el total general
 * reciclado durante un periodo determinado. <b>pre</b> El conjunto asociado
 * debe estar registrado previamente en el sistema y las cantidades registradas
 * no deben ser negativas. <br>
 * <b>post</b> El objeto queda disponible para procesos de transferencia,
 * persistencia y visualizacion de informacion ambiental dentro del sistema.
 * <br>
 * 
 * @author GreenBuilding Group
 * @version 1.0
 */
public class RegistroReciclajeDTO extends RegistroConsumo {
	...
	/**
	 * Constructor por defecto. Crea un objeto RegistroReciclajeDTO sin datos
	 * inicializados. <b>pre</b> No existen precondiciones para este constructor.
	 * <br>
	 * <b>post</b> Se crea un objeto RegistroReciclajeDTO con todos sus atributos en
	 * valores por defecto. <br>
	 */
	public RegistroReciclajeDTO() {
	}

	/**
	 * Constructor parcial. Crea un objeto RegistroReciclajeDTO inicializando las
	 * cantidades recicladas registradas. <b>pre</b> Las cantidades registradas no
	 * deben ser negativas. <br>
	 * <b>post</b> Se crea un objeto RegistroReciclajeDTO con los datos de reciclaje
	 * inicializados. <br>
	 * 
	 ...
	 */
	public RegistroReciclajeDTO(double kgPapel, double kgPlastico, double kgVidrio, double kgMetal, double kgOrganico,
			double totalKg) {
		super();
	...
	/**
	 * Constructor completo. Crea un objeto RegistroReciclajeDTO con todos sus
	 ...
	 * negativas. <br>
	 * <b>post</b> Se crea un objeto RegistroReciclajeDTO completamente inicializado
	 * y listo para ser utilizado dentro del sistema. <br>
	 * 
	 ...
	 * @param totalKg       Cantidad total reciclada. totalKg >= 0
	 */
	public RegistroReciclajeDTO(String id, Conjunto conjunto, String periodo, LocalDate fechaRegistro,
	...
	/**
	 * Constructor basico. Crea un objeto RegistroReciclajeDTO heredando informacion
	 * general de RegistroConsumo. <b>pre</b> El id, conjunto, periodo,
	 * fechaRegistro y registradoPor no deben ser null. <br>
	 * <b>post</b> Se crea un objeto RegistroReciclajeDTO con la informacion general
	 * inicializada. <br>
	 * 
	 * @param id            Identificador unico del registro. id != null, id != ""
	 * @param conjunto      Conjunto asociado al registro. conjunto != null
	 ...
	 * RegistroReciclajeDTO debe estar instanciado. <br>
	...
	/**
	 * Asigna la cantidad de papel reciclado. <b>pre</b> El objeto
	 * RegistroReciclajeDTO debe estar instanciado. <br>
	...
	/**
	 * Asigna la cantidad de metal reciclado. <b>pre</b> El objeto
	 * RegistroReciclajeDTO debe estar instanciado. <br>
	...
	/**
	 * Retorna la cantidad total reciclada. <b>pre</b> El objeto
	 * RegistroReciclajeDTO debe estar instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
	...
	/**
	 * Asigna la cantidad total reciclada. <b>pre</b> El objeto RegistroReciclajeDTO
	 ...
	 * principales. <b>pre</b> El objeto RegistroReciclajeDTO debe estar
	 * instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
