 ...
 * Manager. Esta clase permite gestionar solicitudes relacionadas con daños,
 * reparaciones o actividades de mantenimiento dentro del conjunto residencial.
 * 
 ...
 * <b>post</b> La solicitud queda registrada y disponible para procesos de
 * seguimiento y gestion de mantenimiento. <br>
 * 
...
public class SolicitudMantenimiento implements Serializable {
	...
	/**
	 * Constructor por defecto. Crea un objeto SolicitudMantenimiento sin datos
	 * inicializados. <b>pre</b> No existen precondiciones para este constructor.
	 * <br>
	 * <b>post</b> Se crea un objeto SolicitudMantenimiento con todos sus atributos
	 * en null o valores por defecto. <br>
	 */
	public SolicitudMantenimiento() {
	}

	/**
	 * Constructor parcial. Crea un objeto SolicitudMantenimiento con los datos
	 ...
	 * <b>post</b> Se crea un objeto SolicitudMantenimiento inicializado con la
	 ...
	 *                       null
	 */
	public SolicitudMantenimiento(String id, String descripcion, String tipo, String prioridad, String estado,
