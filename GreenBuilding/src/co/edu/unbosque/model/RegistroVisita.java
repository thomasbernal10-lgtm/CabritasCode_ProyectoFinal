...
/**
 * Representa el registro de ingreso y salida de un visitante dentro del sistema
 * GreenBuilding Manager. Esta clase almacena informacion relacionada con el
 * visitante, la hora de entrada, la hora de salida y el vigilante encargado del
 * registro.
 * 
 * Los registros de visita permiten llevar control de acceso y seguridad dentro
 * del conjunto residencial, facilitando consultas y seguimiento de visitantes.
 * <b>pre</b> El visitante debe estar registrado previamente en el sistema. Las
 * fechas de entrada y salida deben ser validas. <br>
 * <b>post</b> El registro de visita queda disponible para procesos de control,
 * seguridad y consultas administrativas dentro del sistema. <br>
 * 
...
public class RegistroVisita implements Serializable {
	...
	/**
	 * Constructor por defecto. Crea un objeto RegistroVisita sin datos
	 * inicializados. <b>pre</b> No existen precondiciones para este constructor.
	 * <br>
	 * <b>post</b> Se crea un objeto RegistroVisita con todos sus atributos en null
	...
	/**
	 * Constructor completo. Crea un objeto RegistroVisita con todos sus atributos
	 * inicializados. <b>pre</b> El id, visitante, horaEntrada y vigilanteRegistro
	 * no deben ser null. <br>
	 * <b>post</b> Se crea un objeto RegistroVisita completamente inicializado y
	 ...
	 */
	public RegistroVisita(String id, Visitante visitante, LocalDateTime horaEntrada, LocalDateTime horaSalida,
	 ...
	 * RegistroVisita debe estar instanciado. <br>
	...
	/**
	 * Asigna el visitante asociado al registro. <b>pre</b> El objeto RegistroVisita
	 ...
	 * principales. <b>pre</b> El objeto RegistroVisita debe estar instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
