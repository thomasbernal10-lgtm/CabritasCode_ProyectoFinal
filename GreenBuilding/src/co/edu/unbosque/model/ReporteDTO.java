...
/**
 * Representa un objeto de transferencia de datos (DTO) para reportes dentro del
 * sistema GreenBuilding Manager. Esta clase permite transportar informacion
 * relacionada con reportes administrativos, operativos, financieros,
 * ambientales y de convivencia entre las diferentes capas de la aplicacion sin
 * exponer directamente la logica de negocio.
 * 
 * Los objetos ReporteDTO son utilizados para procesos de persistencia,
 * consultas y visualizacion de informacion relacionada con la gestion del
 * conjunto residencial. <b>pre</b> El conjunto asociado debe existir
 * previamente en el sistema. El tipo de reporte debe corresponder a una de las
 * categorias definidas. <br>
 * <b>post</b> El objeto queda disponible para procesos de transferencia y
 * manejo administrativo de reportes dentro del sistema. <br>
 * 
...
public class ReporteDTO implements Serializable {
	...
	/**
	 * Constructor por defecto. Crea un objeto ReporteDTO sin datos inicializados.
	 * <b>pre</b> No existen precondiciones para este constructor. <br>
	 * <b>post</b> Se crea un objeto ReporteDTO con todos sus atributos en null o
	...
	/**
	 * Constructor completo. Crea un objeto ReporteDTO con todos sus atributos
	 * inicializados. <b>pre</b> El id, tipo, titulo, contenido, fechaGeneracion,
	 * generadoPor y conjunto no deben ser null. <br>
	 * <b>post</b> Se crea un objeto ReporteDTO completamente inicializado y listo
	 ...
	 */
	public ReporteDTO(String id, String tipo, String titulo, String contenido, LocalDateTime fechaGeneracion,
	...
	/**
	 * Retorna el tipo de reporte administrativo. <b>pre</b> El objeto ReporteDTO
	...
	/**
	 * Retorna el tipo de reporte operativo. <b>pre</b> El objeto ReporteDTO debe
	...
	/**
	 * Retorna el tipo de reporte financiero. <b>pre</b> El objeto ReporteDTO debe
	 * estar instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
	...
	/**
	 * Retorna el tipo de reporte ambiental. <b>pre</b> El objeto ReporteDTO debe
	 * estar instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
	...
	/**
	 * Retorna el tipo de reporte de convivencia. <b>pre</b> El objeto ReporteDTO
	 * debe estar instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
	...
	/**
	 * Retorna el identificador unico del reporte. <b>pre</b> El objeto ReporteDTO
	 * debe estar instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
	...
	/**
	 * Asigna el identificador unico del reporte. <b>pre</b> El objeto ReporteDTO
	 * debe estar instanciado. <br>
	...
	/**
	 * Retorna el tipo del reporte. <b>pre</b> El objeto ReporteDTO debe estar
	 * instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
	...
	/**
	 * Asigna el tipo del reporte. <b>pre</b> El objeto ReporteDTO debe estar
	 * instanciado. <br>
	...
	/**
	 * Retorna el titulo del reporte. <b>pre</b> El objeto ReporteDTO debe estar
	 * instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
	...
	/**
	 * Asigna el titulo del reporte. <b>pre</b> El objeto ReporteDTO debe estar
	 * instanciado. <br>
	...
	/**
	 * Retorna el contenido del reporte. <b>pre</b> El objeto ReporteDTO debe estar
	 * instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
	...
	/**
	 * Asigna el contenido del reporte. <b>pre</b> El objeto ReporteDTO debe estar
	 * instanciado. <br>
	 ...
	 * ReporteDTO debe estar instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
	...
	/**
	 * Retorna el conjunto asociado al reporte. <b>pre</b> El objeto ReporteDTO debe
	 * estar instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
	...
	/**
	 * Asigna el conjunto asociado al reporte. <b>pre</b> El objeto ReporteDTO debe
	 * estar instanciado. <br>
	 ...
	 * <b>pre</b> El objeto ReporteDTO debe estar instanciado. <br>
	 * <b>post</b> No se modifica el estado del objeto. <br>
	 * 
