...
/**
 * Panel superior utilizado en las ventanas de propietarios del sistema.
 * Contiene el titulo de la aplicacion, la informacion del apartamento, el
 * nombre del propietario en sesion y el boton de cierre de sesion.
 * <p>
 * Este componente se utiliza como barra de navegacion visual para las
 * interfaces de propietarios en GreenBuilding Manager.
 * </p>
 * 
 ...
 * @version 1.0
 */
public class BarraPropietario extends JPanel {

	/**
	 * Serial generado para la clase.
	 */
	private static final long serialVersionUID = 4812947120938471030L;
	...
	/**
	 * Etiqueta que muestra el numero del apartamento asociado al propietario.
	 */
	private JLabel lblApartamento;

	/**
	 * Etiqueta que muestra el nombre del propietario en sesion.
	 */
	private JLabel lblUsuario;

	/**
	 * Construye e inicializa la barra superior de propietario del sistema.
	 ...
	 * @param colorBorde        Color utilizado para el nombre del propietario
	 * @param username          Nombre del propietario en sesion
	 ...
	 */
	public BarraPropietario(Color colorVerdeOscuro, Color colorBlanco, Color colorTextoSuave, Color colorBorde,
		...
		lblUsuario = new JLabel("Propietario: " + username);
	 ...
	 * propietario. <b>pre</b> La barra debe haber sido inicializada correctamente.
	 * <br>
	 * <b>post</b> No se modifica ningun estado del sistema. <br>
	 *
	 * @return JLabel correspondiente al apartamento del propietario
	 */
	...
	/**
	 * Retorna la etiqueta que contiene el nombre del propietario en sesion.
	 * <b>pre</b> La barra debe haber sido inicializada correctamente. <br>
	 * <b>post</b> No se modifica ningun estado del sistema. <br>
	 *
	 * @return JLabel correspondiente al usuario propietario
	 */
